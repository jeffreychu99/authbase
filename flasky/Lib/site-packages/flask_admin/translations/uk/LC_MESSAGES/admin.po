...
msgstr "Не можу працювати с непорожніми директоріями"
...
msgstr[0] "Принаймні %(num)d елемент є обов'язковим"
msgstr[1] "Принаймні %(num)d елемента є обов'язковими"
msgstr[2] "Принаймні %(num)d елементів є обов'язковими"
...
msgstr "Tablib залежність не інстальовано."

#: ../flask_admin/model/base.py:2249
#, python-format
msgid "Export type \"%(type)s not supported."
msgstr "Експорт \"%(type)s типу не підтримується."
...
msgstr "Будь ласка, оберіть модель"
...
msgstr "Зберегти й додати інший"
